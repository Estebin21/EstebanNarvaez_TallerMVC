...
namespace EstebanNarvaez_TallerMVC.Controllers
{
    public class JugadorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NombreJugador,Posicion,Edad,IdEquipo")] Jugador jugador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NombreJugador,Posicion,Edad,IdEquipo")] Jugador jugador)
        {
            if (id != jugador.Id)
            {
                return NotFound();
