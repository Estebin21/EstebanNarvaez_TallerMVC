...
namespace EstebanNarvaez_TallerMVC.Controllers
{
    public class EstadiosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NombreEstadio,DireccionEstadio,CiudadEstadio,CapacidadEstadio")] Estadio estadio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NombreEstadio,DireccionEstadio,CiudadEstadio,CapacidadEstadio")] Estadio estadio)
        {
            if (id != estadio.Id)
            {
                return NotFound();
