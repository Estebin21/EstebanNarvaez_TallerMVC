...
namespace EstebanNarvaez_TallerMVC.Controllers
{
    public class EquiposController : Controller
    {
        ...
        {
            var ligaProContext = _context.Equipo.Include(e => e.Estadio);
        ...
        public async Task<IActionResult> Create([Bind("Id,NombreEquipo,CiudadEquipo,TitulosEquipo,AceptaExtranjeros,IdEstadio")] Equipo equipo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NombreEquipo,CiudadEquipo,TitulosEquipo,AceptaExtranjeros,IdEstadio")] Equipo equipo)
        {
            if (id != equipo.Id)
            {
                return NotFound();
